...
```{r}
orig_data <- dts[, !(colnames(dts) %in% c("WEEKS_WORKED_NUMERIC"))]
orig_data$NUM_MARR <- as.factor(orig_data$NUM_MARR)
```

TODO: I think that before jumping into the linear regression analysis, we should study variables a little bit more by vizualizing them and plotting the relationship with the response variable. 
